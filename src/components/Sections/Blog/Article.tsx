...
export default function Article({ content, tagPosts }: Readonly<ArticleProps>) {
  return (
    <section className='mt-4 h-auto pt-4'>
      <div className='mx-auto justify-center max-w-screen-sm md:max-w-screen-2xl md:py-12'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
          <div className='md:col-span-3'>
            <div className="mx-2 max-w-full md:max-w-screen-lg md:mx-auto">
              <Markdown>{content.content}</Markdown>
            </div>
          </div>
          <div className='md:col-span-1'>
            <div className="mx-2 max-w-full md:max-w-screen-md md:mx-auto">
