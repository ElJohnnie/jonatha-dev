...
export default function AnimateButton({
  ...
  return (
    <Link
      href={route}
      className='align-center text-white-100 hover:text-white-500 group relative inline-flex items-center justify-center overflow-hidden rounded rounded-md border border-transparent bg-transparent px-12 py-3 text-sm font-bold focus:outline-none focus:ring active:bg-indigo-600 active:text-white'
    >
